...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('proizvodstvo', '0005_alter_favouriteadv_user'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='status',
            field=models.TextField(choices=[("<class 'proizvodstvo.models.AdvertisementStatusChoices.Meta'>", 'Meta'), ('OPEN', 'Открыто'), ('CLOSED', 'Закрыто')], default='OPEN'),
        ),
        migrations.AlterField(
